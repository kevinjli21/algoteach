...
-- All text uses plain single-quoted strings with \n for line breaks.
-- ============================================================
...
INSERT INTO public.problems (
  pattern_id, title, slug, difficulty, importance_context, problem_statement, starter_code, expected_pattern_approach
)
SELECT
  id,
  'Valid Palindrome',
